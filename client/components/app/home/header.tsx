...
import { ChevronDown, Globe, LinkIcon } from "lucide-react";
        ...
        <header className="bg-[#0f1c2e] py-4 px-4">
            <div className="container mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <Link href="auth/login" className="hidden md:block text-white hover:text-gray-300">
                        Log in
                    </Link>
                    <Link
                        href="#"
                    ...
                    <Link href="auth/signup" className="rounded bg-white px-4 py-2 text-sm font-medium text-[#0f1c2e] hover:bg-gray-100">
                        Sign up Free
                    </Link>
                    <MobileMenu />
                </div>
